...
(() => {
									...
									if (
										...
										console.warn(
											`Unsupported bare value data type: "${
												t.value
											}".\nOnly valid data types are: ${Be.map(
												(e) => `"${e}"`,
											).join(", ")}.\n`,
										);
										let r = t.value,
	...
	function qe(e, t, r, n, o = "") {
		...
		return i
			? [
					j(e, l(Oe(t, n))),
					C("@supports (color: lab(from red l a b))", [j(e, l(a))]),
			  ]
			: [j(e, l(a))];
	}
	function He(e, t, r, n, o = "") {
		...
		return i
			? [
					...
					C("@supports (color: lab(from red l a b))", [j(e, o + a)]),
			  ]
			: [j(e, o + a)];
	}
	...
	function gt(e, t) {
		let r = (function (e) {
				...
				for (let [e, t, r] of [
					...
					a(e, t, (e) => [j(r, e)], { supportsFractions: !0 });
				for (let [e, t] of [
					["full", "100%"],
					["min", "min-content"],
					["max", "max-content"],
				...
				for (let [e, t] of [
					...
					a(e, ["--scroll-margin", "--spacing"], (e) => [j(t, e)], {
						supportsNegative: !0,
					});
				for (let [e, t] of [
					...
					a(e, ["--scroll-padding", "--spacing"], (e) => [j(t, e)]);
				...
				n("grid-flow-row", [["grid-auto-flow", "row"]]),
					...
					o("grid-cols", {
						...
						handleBareValue: ({ value: e }) =>
							je(e) ? `repeat(${e}, minmax(0, 1fr))` : null,
					...
					a("gap", ["--gap", "--spacing"], (e) => [j("gap", e)]),
					a("gap-x", ["--gap", "--spacing"], (e) => [j("column-gap", e)]),
					a("gap-y", ["--gap", "--spacing"], (e) => [j("row-gap", e)]),
					a(
						"space-x",
						["--space", "--spacing"],
						(e) => [
					...
					});
				{
					...
					t.functional("filter", (e) => {
						if (!e.modifier) {
							if (null === e.value) return [l(), j("filter", i)];
							if ("arbitrary" === e.value.kind)
				...
				}
				{
					...
					o("transition", {
						...
						handle: (e) => [
							...
							j("transition-timing-function", i),
							j("transition-duration", a),
						],
						staticValues: {
					...
					]);
				{
						...
						t.functional("shadow", (t) => {
							...
							switch (t.value.value) {
								case "none":
									return t.modifier
										? void 0
										: [s(), j("--tw-shadow", l), j("box-shadow", a)];
								case "inherit":
									return t.modifier
										? void 0
							...
							}
							{
								...
								if (r)
									return [
										s(),
										j("--tw-shadow-color", Re(r, "var(--tw-shadow-alpha)")),
									];
							}
						}),
						r("shadow", () => [
						...
						t.functional("inset-shadow", (t) => {
							...
							switch (t.value.value) {
								case "none":
									return t.modifier
										? void 0
										: [s(), j("--tw-inset-shadow", l), j("box-shadow", a)];
								case "inherit":
									return t.modifier
										? void 0
					...
					t.functional("ring", (t) => {
						if (!t.value) {
							...
							return [s(), j("--tw-ring-shadow", o(r)), j("box-shadow", a)];
						}
						if ("arbitrary" === t.value.kind) {
							let r = t.value.value;
							return "length" ===
								...
								? t.modifier
									? void 0
									: [s(), j("--tw-ring-shadow", o(r)), j("box-shadow", a)]
								: ((r = _e(r, t.modifier, e)),
		...
		for (let [e, n] of r)
			if (null != n && !1 !== n)
				if ("object" != typeof n) {
					...
					for (let r of n)
						"string" == typeof r ? t.push(j(e, r)) : t.push(C(e, Zt(r)));
		...
		let n = (function ({ center: e, padding: t, screens: r }, n) {
			...
			if (
				...
				for (let [e, t] of Object.entries(r)) {
					...
					i.set(e, S("@media", `(width >= ${t})`, [j("max-width", t)]));
				}
			}
			if ("object" == typeof t && null !== t) {
				...
				for (let [t, , r] of e)
					if (i && i.has(t)) i.get(t).nodes.push(j("padding-inline", r));
					else {
						if (i) continue;
						o.push(
							S("@media", `(width >= theme(--breakpoint-${t}))`, [
				...
				e.utilities.suggest("bg-left-top", () => []),
					...
					e.utilities.functional("flex-shrink", (e) => {
						if (!e.modifier) {
							...
							if (Ce(e.value.value)) return [j("flex-shrink", e.value.value)];
						}
					}),
					...
					e.utilities.functional("flex-grow", (e) => {
						if (!e.modifier) {
							...
							if (Ce(e.value.value)) return [j("flex-grow", e.value.value)];
						}
					}),
					...
					let n = function ({ negative: t }) {
						return (n) => {
							if (!n.value) {
								...
								return null === o ? void 0 : [j(r, t ? `calc(${o} * -1)` : o)];
							}
							...
							if (null === o) {
								let t = e.theme.resolve(null, ["--spacing"]);
								t && Te(n.value.value) && (o = `calc(${t} * ${n.value.value})`);
							}
							if (null !== o) return [j(r, t ? `calc(${o} * -1)` : o)];
						};
					};
	...
	async function Ar(t, r = {}) {
		let o = n(t, { from: r.from }),
			i = await (async function (e, t = {}) {
				...
				n.unshift(
					T("! tailwindcss v4.2.2 | MIT License | https://tailwindcss.com "),
				);
				let u = new Set(),
					d = null,
					f = 0,
			...
			Or.start(`Build #${t} (${e})`),
				"full" === e &&
					(await (async function () {
						...
						let e = document.querySelectorAll(`style[type="${jr}"]`),
							t = "";
